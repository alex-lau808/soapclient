 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://service.alex.com", wsdlLocation = "http://localhost:8080/SampleWS/wsdl/PersonServiceImpl.wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://service.alex.com", "PersonServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SampleWS/wsdl/PersonServiceImpl.wsdl");
     ...
     */
    @WebEndpoint(name = "PersonServiceImpl")
    public PersonServiceImpl getPersonServiceImpl() {
        return super.getPort(new QName("http://service.alex.com", "PersonServiceImpl"), PersonServiceImpl.class);
    }
     ...
     */
    @WebEndpoint(name = "PersonServiceImpl")
    public PersonServiceImpl getPersonServiceImpl(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.alex.com", "PersonServiceImpl"), PersonServiceImpl.class, features);
    }
